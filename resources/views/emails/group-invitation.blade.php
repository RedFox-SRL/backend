...
<p>Has sido invitado a unirte al grupo "{{ $invitation->group->short_name }}" en el sistema de gestión de proyectos.</p>
<p>Para aceptar la invitación, haz clic en el siguiente enlace:</p>
<a href="{{ url('/api/invitations/accept/' . $invitation->token) }}">Aceptar invitación</a>
<p>Si no deseas unirte al grupo, puedes rechazar la invitación haciendo clic aquí:</p>
<a href="{{ url('/api/invitations/reject/' . $invitation->token) }}">Rechazar invitación</a>
